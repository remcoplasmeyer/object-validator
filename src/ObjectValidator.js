  ...
  static validate (object, schema) {
    ...
    Object.keys(object).forEach(schemaKey => {
      if (schema[schemaKey] === undefined) {
        throw new ValidationError(`found nonexistant schema key '${schemaKey}' on object`)
      }
    ...
    Object.keys(schema).forEach(schemaKey => {
      if (object[schemaKey] === undefined) {
        throw new ValidationError(`missing required field '${schemaKey}' on object`)
      }
    })
